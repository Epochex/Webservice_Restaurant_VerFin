...
@XmlRootElement(name = "getAllRestaurants", namespace = "http://soap.management.restaurant/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getAllRestaurants", namespace = "http://soap.management.restaurant/")
