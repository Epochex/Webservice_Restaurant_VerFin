...
@XmlRootElement(name = "getRestaurantByIdResponse", namespace = "http://soap.management.restaurant/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "getRestaurantByIdResponse", namespace = "http://soap.management.restaurant/")
